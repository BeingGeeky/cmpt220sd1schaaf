  ...
  public static void main(String[] args) {
    ...
    if (select==0){
      ...
      for (int n=0; n<numIdeas; n++){ //Phase 3: allow more than 1 word to be generated
        totallyRandom(ideas, ideasLength);
      }
    ...
    //..or, if none are selected, display a message
      ...
      System.out.println("Thanks for playing! Try again by restarting.");
    }
} //end of main class
  
//method to generate completely random ideas
  public static void totallyRandom(String[][] array, int arrayLength){  
