...
public class Prj2_schaaf {
  public static void main(String[] args) {
    ...
    System.out.println("Would you like a random idea or would you like to select your ideas? Enter 0 for random or 1 to make a selection.");
    ...
    String[][] ideas = {/*items*/
      /*lists                     1                     2                     3                4                          5 */ 
        ...
        /*13 Witches*/           {"Wicca",            "Moonlight",          "Black Cat",     "Pentagram",               "Rule of Three"},
        ...
        /*21 Art Movements4*/    {"Pop Art",          "Post-Impressionism", "Op Art",        "Naturalism",              "Comic Book"},
        };
    ...
    if (select==0){
      ...
      for (int n=0; n<numIdeas; n++){ //Phase 3: allow more than 1 word to be generated
        idea += totallyRandom(ideas, ideasLength) + " ";
      }
      System.out.println("Idea is "+idea+" ");

    //...or a more specific selection  
    } else if (select==1){
       kindaRandom(ideas, ideasLength, input);
    ...
    for (int i=0; i < saveList.size(); i++){
      System.out.print(Arrays.deepToString(saveList.toArray()));
    }
    System.out.println("\n\nNow go on! Git creatin'!\n");
} //end of main class
  
//method to generate completely random ideas
  public static String totallyRandom(String[][] array, int arrayLength){  
    int randomIdea = (int)(Math.random() * arrayLength);
    int arrayItem = (int)(Math.random() * array[randomIdea].length);
    String arrayIdea = array[randomIdea][arrayItem];
 //   System.out.print (arrayIdea+ " ");
    return arrayIdea;
  }//end of totallyRandom method

//method to select from certain lists
  public static void kindaRandom(String[][] array, int arrayLength, Scanner input){
    //display lists  
    System.out.println("Enter a number between to select a list:\n 0 Medium\n 1 Jungle\n 2 Landscape\n 3 Forest\n 4 Country\n 5 Insect\n 6 Woodland Creatures\n 7 Big cats\n 8 Snakes\n 9 Art Movements1\n 10 Primary Colors\n 11 Texture\n 12 Fairy Tales\n 13 Witches\n 14 Fairies\n 15 Romance\n 16 World Cities\n 17 Artists\n 18 Candy\n 19 Art Movements2\n 20 Art Movements3\n 21 Art Movements4");
    //generate idea from specified list
    int arrayList = input.nextInt();
    int arrayItem = (int)(Math.random() * array[arrayList].length);
